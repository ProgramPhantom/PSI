...
const AddSchemeDialog: React.FC<AddSchemeDialogProps> = ({isOpen, onClose, onSchemeCreated}) => {
  ...
  const handleSubmit = () => {
    if (!newSchemeName.trim() || ENGINE.schemeManager.allSchemeNames.includes(newSchemeName.trim()))
      return;
      ...
      <div className={Classes.DIALOG_BODY}>
        ...
        {uploadedSchemeData?.svgElements && (
          <SVGUploadList
            ...
            elements={Object.entries(uploadedSchemeData.svgElements).map(([name, el]) => ({
              name,
              element: el as any
            }))}
            uploads={svgUploads}
