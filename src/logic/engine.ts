...
class ENGINE {
  ...
  static removeSVGSingleton(
    ...
    this.singletons[schemeName].SVG_TEMPLATES = this.singletons[schemeName].SVG_TEMPLATES.filter(
      (singleton) => singleton.ref !== data.ref
    );
    this.emitChange();
  }
  static removeRectSingleton(
    ...
    this.singletons[schemeName].RECT_TEMPLATES = this.singletons[schemeName].RECT_TEMPLATES.filter(
      (singleton) => singleton.ref !== data.ref
    );
    this.emitChange();
  }
