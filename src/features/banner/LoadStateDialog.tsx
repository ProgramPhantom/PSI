...
export function LoadStateDialog(props: ILoadStateDialogProps) {
    ...
    const isSvgRefSatisfied = (svgRef: string): boolean => {
        if (ENGINE.schemeManager.allSVGDataRefs.includes(svgRef) === true) { return true }  // Scheme Manager
        if (Object.prototype.hasOwnProperty.call(svgUploads, svgRef)) { return true }  // Uploads
        return false 
    }
    ...
    return (
        ...
        <Dialog isOpen={isSVGRequirementsOpen}
            onClose={() => {
