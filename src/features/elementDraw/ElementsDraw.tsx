  ...
  return (
    <div style={{height: "100%", overflow: "hidden"}}>
      ...
      <Dialog
        ...
        <DialogBody>
          <Text>
            Are you sure you want to delete the scheme "{selectedScheme}"? This action cannot be
            undone.
          </Text>
        </DialogBody>
        ...
        <DialogFooter
          actions={
            <>
              <Button text="Cancel" onClick={handleDeleteSchemeDialogClose} variant="minimal" />
              <Button text="Delete" intent="danger" onClick={handleDeleteSchemeConfirm} />
            </>
          }></DialogFooter>
      </Dialog>
    </div>
