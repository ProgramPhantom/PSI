...
To export the diagram to `.nmrd`, press the Export button on the `Banner` or in the `Diagram Form` and save it to your computer. 

In order to load a `.nmrd` file into the application, open the load diagram dialog by pressing the button on the banner and then drag and drop or select a file from your filesystem. 